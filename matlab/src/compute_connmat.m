function compute_connmat(roi_csv1,roi_csv2,out_basename)
...
writetable(R,['R_' out_basename '.csv'],'WriteRowNames',true)
writetable(Z,['Z_' out_basename '.csv'],'WriteRowNames',true)
